import { PokemonType } from '@/types/game.types'
...
export function getTypeEffectiveness(attackType: PokemonType, defendTypes: PokemonType[]): number {
  let effectiveness = 1.0
  
  for (const defendType of defendTypes) {
    const modifier = TYPE_CHART[attackType]?.[defendType]
